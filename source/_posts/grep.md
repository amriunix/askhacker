...
| `-r`   | grep -r 'askhacker.com' /var/log/nginx/ | Recursive search _(within subdirs)_                  |
...
### Refer
- [Regex syntax](/regex) _(askhacker.com)_
- [Regex examples](/regex#regex-examples) _(askhacker.com)_
