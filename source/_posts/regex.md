...
- [Regex in Python](#regex-in-python) _(askhacker.com)_
- [Regex in JavaScript](#regex-in-javascript) _(askhacker.com)_
- [Regex in PHP](#regex-in-php) _(askhacker.com)_
- [Regex in Java](#regex-in-java) _(askhacker.com)_
- [Regex in MySQL](#regex-in-mysql) _(askhacker.com)_
- [Regex in Vim](/vim#search-and-replace) _(askhacker.com)_
- [Regex in Emacs](/emacs#search) _(askhacker.com)_
