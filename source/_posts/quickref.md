...
categories:
    - Other
intro: This is the magic syntax variant manual that you can use on askhacker.com, It's a good practice for contributors.
plugins:
    - copyCode
---
...
│   │   ├── awk.md
│   │   ├── vim.md # => askhacker.com/vim
│   │   ├── php.md
│   │   ├── css.md # => askhacker.com/css
│   │   ├── ...
│   └── widget   # Widget files
│       └── chmod.html
...
All the magic variants supported by askhacker.com
